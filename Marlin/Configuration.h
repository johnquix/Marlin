...
#define STRING_CONFIG_H_AUTHOR "(John DiCapua, Geeetech A(ero)10)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "A(ero)10"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // A(ero)10 [A10 w/ Titan Aero]
  #define  DEFAULT_Kp 20.53
  #define  DEFAULT_Ki 2.14
  #define  DEFAULT_Kd 49.20
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Geeetech A10 
  #define  DEFAULT_bedKp 62.62   
  #define  DEFAULT_bedKi 11.94    
  #define  DEFAULT_bedKd 218.87  
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 16, 80 } // ...or, set your own edit limits
#endif
